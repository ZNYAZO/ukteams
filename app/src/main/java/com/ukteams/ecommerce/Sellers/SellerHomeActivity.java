...
import com.ukteams.ecommerce.ViewHolder.ItemViewHolder;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent intentCategory = new Intent(SellerHomeActivity.this, SellerHomeActivity.class);
                    startActivity(intentCategory);
                    return true;

                case R.id.navigation_add:
                    Intent intentHome = new Intent(SellerHomeActivity.this, SellerProductCategoryActivity.class);
