...
public class SettingsActivity extends AppCompatActivity {
    //this class creates profile settings for our app user
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileChangeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                //using the crop image dependency to crop user profile images
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE  &&  resultCode==RESULT_OK  &&  data!=null) {
            ...
            profileImageView.setImageURI(imageUri); //display image to the user
        }
        else
        {
        ...
        UsersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {//if user exists
                    if (dataSnapshot.child("image").exists()) //if user image exists
                    {
