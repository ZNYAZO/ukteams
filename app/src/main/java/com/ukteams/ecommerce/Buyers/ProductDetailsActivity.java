...
public class ProductDetailsActivity extends AppCompatActivity {
    //this class shows the products chosen by the user, then adds them to cart
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productID = getIntent().getStringExtra("pid"); // get product id
        ...
        cartListRef.child("User View").child(Prevalent.currentOnlineUser.getPhone())
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {//if the user's cartlist is successful the admin gets to see it
