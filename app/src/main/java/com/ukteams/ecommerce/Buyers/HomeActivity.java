...
import com.ukteams.ecommerce.Admin.AdminMaintainProductsActivity;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    //this is the user/client/buyer home page
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options =
                new FirebaseRecyclerOptions.Builder<Products>()
                        .setQuery(ProductsRef.orderByChild("productState").equalTo("Approved"), Products.class) //only when approved by the Admin will it be displayed to the buyer
                        .build();
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                else
                                {
                                    ...
                                    intent.putExtra("pid", model.getPid()); //product id
                                    startActivity(intent);
                                }
                            }
                        });
